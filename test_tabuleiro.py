...
from simob import Jogador, impulsivo
from tabuleiro import Tabuleiro, dado

def test_inicia_tabuleiro():
    ...

def test_move_jogador_um_passo():    
    jogador = Jogador(impulsivo)
    tabuleiro = Tabuleiro(propriedades=[], jogadores=[jogador])
...
def test_inicializa_dois_jogadores():
    ...
    tabuleiro = Tabuleiro(propriedades=[], jogadores=lista_jogadores)
